...
public class TestMessageCodec {
	...
	// private final MessageVisitor<Void> visitor = new
	...
	public void test1() throws Exception {
		...
		final MarketMessage message = MarketMessage.newBuilder()
				.setMarketId(123).build();

		final MarketPacket base = null; // MessageCodec.encode(message).build();
