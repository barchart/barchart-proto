...
///////////////////////////////////////////////////////////////////////
//
// unsigned int decode_u64(Fast* fast, unsigned int tag)
//
// wrapper function for fast_decode_u64 
//
///////////////////////////////////////////////////////////////////////

u64 decode_u64(Fast* fast, unsigned int tag)
{
    u64 temp;
    fast_decode_u64(fast->codec, tag, &temp); 
    return temp;
}
